...
define_tunable_parameters!(
    (RFP_UNCERTAINTY_SCALE, rfp_uncertainty_scale_parameter, i32, 64, 0, 192, 2.0),
    (RFP_UNCERTAINTY_MAX_MARGIN, rfp_uncertainty_max_margin_parameter, i32, 64, 0, 256, 2.0),
    ...
    (RFP_UNCERTAINTY_CONFIDENT_WEIGHT, rfp_uncertainty_confident_weight_parameter, i32, 192, 0, 384, 4.0),
    (RFP_UNCERTAINTY_UNCERTAIN_WEIGHT, rfp_uncertainty_uncertain_weight_parameter, i32, 192, 0, 384, 4.0),
    (RFP_UNCERTAINTY_DEADBAND, rfp_uncertainty_deadband_parameter, i32, 4, 0, 64, 0.5),
    ...
    (LMR_UNCERTAINTY_REFERENCE, lmr_uncertainty_reference_parameter, i32, 850, 200, 1600, 8.0),
    (LMR_UNCERTAINTY_WEIGHT, lmr_uncertainty_weight_parameter, i32, 384, 0, 768, 8.0),
    (LMR_UNCERTAINTY_CONFIDENT_WEIGHT, lmr_uncertainty_confident_weight_parameter, i32, 384, 0, 768, 8.0),
    (LMR_UNCERTAINTY_DEADBAND, lmr_uncertainty_deadband_parameter, i32, 32, 0, 256, 2.0),
    (LMR_UNCERTAINTY_MIN_DEPTH, lmr_uncertainty_min_depth_parameter, u32, 4, 2, 6, 0.5),
    (LMR_UNCERTAINTY_MAX_DEPTH, lmr_uncertainty_max_depth_parameter, u32, 10, 6, 16, 0.5),
    (LMR_UNCERTAINTY_MIN_MOVE, lmr_uncertainty_min_move_parameter, u32, 4, 2, 12, 0.5),
    ...
    (FUTILITY_UNCERTAINTY_REFERENCE, futility_uncertainty_reference_parameter, i32, 400, 100, 1000, 8.0),
    (FUTILITY_UNCERTAINTY_WEIGHT, futility_uncertainty_weight_parameter, i32, 24, 0, 96, 2.0),
    (FUTILITY_UNCERTAINTY_CONFIDENT_WEIGHT, futility_uncertainty_confident_weight_parameter, i32, 32, 0, 96, 2.0),
    (FUTILITY_UNCERTAINTY_DEADBAND, futility_uncertainty_deadband_parameter, i32, 16, 0, 128, 1.0),
