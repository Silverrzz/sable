...
define_tunable_parameters!(
    (MAX_CORRECTION_HISTORY_SCORE, max_correction_history_score_parameter, i32, 536, 402, 670, 54.0),
    (CORRECTION_HISTORY_MINOR_WEIGHT, correction_history_minor_weight_parameter, i32, 209, 157, 261, 21.0),
    (CORRECTION_HISTORY_NON_PAWN_WEIGHT, correction_history_non_pawn_weight_parameter, i32, 344, 258, 430, 34.0),
    (CORRECTION_HISTORY_PREVIOUS_WEIGHT, correction_history_previous_weight_parameter, i32, 156, 117, 195, 16.0),
    (CORRECTION_HISTORY_SAME_SIDE_WEIGHT, correction_history_same_side_weight_parameter, i32, 47, 35, 59, 5.0),
    (CORRECTION_HISTORY_PAWN_UPDATE_SCALE, correction_history_pawn_update_scale_parameter, i32, 159, 119, 199, 16.0),
    (CORRECTION_HISTORY_MINOR_UPDATE_SCALE, correction_history_minor_update_scale_parameter, i32, 150, 113, 188, 15.0),
    (CORRECTION_HISTORY_NON_PAWN_UPDATE_SCALE, correction_history_non_pawn_update_scale_parameter, i32, 215, 161, 269, 22.0),
    (CORRECTION_HISTORY_PREVIOUS_UPDATE_SCALE, correction_history_previous_update_scale_parameter, i32, 145, 109, 181, 15.0),
    (CORRECTION_HISTORY_SAME_SIDE_UPDATE_SCALE, correction_history_same_side_update_scale_parameter, i32, 73, 55, 91, 7.0),
    ...
    (ASPIRATION_INITIAL_WINDOW, aspiration_initial_window_parameter, i32, 19, 14, 24, 2.0),
    ...
    (SINGULAR_EXTENSION_BASE_MARGIN, singular_extension_base_margin_parameter, i32, 52, 39, 65, 5.0),
    (DOUBLE_SINGULAR_EXTENSION_BASE_MARGIN, double_singular_extension_base_margin_parameter, i32, 0, 0, 256, 16.0),
    (TRIPLE_SINGULAR_EXTENSION_BASE_MARGIN, triple_singular_extension_base_margin_parameter, i32, 120, 90, 150, 12.0),
    ...
    (Q_DELTA_PRUNING_MARGIN, q_delta_pruning_margin_parameter, i32, 436, 327, 545, 44.0),
    ...
    (DRAW_PREFERENCE_MAX_SCORE, draw_preference_max_score_parameter, i32, 44, 33, 55, 4.0),
    (ROOT_REPETITION_DEFER_MIN_SCORE, root_repetition_defer_min_score_parameter, i32, 125, 94, 156, 13.0),
...
static SPSA_PARAMETERS: &[fn() -> &'static TunableParameter] = &[
    max_correction_history_score_parameter,
    correction_history_minor_weight_parameter,
    correction_history_non_pawn_weight_parameter,
    correction_history_previous_weight_parameter,
    correction_history_same_side_weight_parameter,
    correction_history_pawn_update_scale_parameter,
    correction_history_minor_update_scale_parameter,
    correction_history_non_pawn_update_scale_parameter,
    ...
    draw_preference_max_score_parameter,
    root_repetition_defer_min_score_parameter,
];
