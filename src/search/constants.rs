...
define_tunable_parameters!(
    (RFP_UNCERTAINTY_SCALE, rfp_uncertainty_scale_parameter, i32, 64, 56, 72, 2.0),
    (RFP_UNCERTAINTY_MAX_MARGIN, rfp_uncertainty_max_margin_parameter, i32, 64, 56, 72, 2.0),
    (RFP_UNCERTAINTY_MIN_DEPTH, rfp_uncertainty_min_depth_parameter, u32, 2, 2, 3, 0.5),
    (RFP_UNCERTAINTY_MAX_DEPTH, rfp_uncertainty_max_depth_parameter, u32, 4, 4, 5, 0.5),
    (RFP_UNCERTAINTY_CONFIDENT_WEIGHT, rfp_uncertainty_confident_weight_parameter, i32, 192, 176, 208, 4.0),
    (RFP_UNCERTAINTY_UNCERTAIN_WEIGHT, rfp_uncertainty_uncertain_weight_parameter, i32, 192, 176, 208, 4.0),
    (RFP_UNCERTAINTY_DEADBAND, rfp_uncertainty_deadband_parameter, i32, 4, 2, 6, 0.5),
    ...
    (LMR_UNCERTAINTY_REFERENCE, lmr_uncertainty_reference_parameter, i32, 850, 800, 900, 8.0),
    (LMR_UNCERTAINTY_WEIGHT, lmr_uncertainty_weight_parameter, i32, 384, 352, 416, 8.0),
    (LMR_UNCERTAINTY_CONFIDENT_WEIGHT, lmr_uncertainty_confident_weight_parameter, i32, 384, 352, 416, 8.0),
    (LMR_UNCERTAINTY_DEADBAND, lmr_uncertainty_deadband_parameter, i32, 32, 24, 40, 2.0),
    (LMR_UNCERTAINTY_MIN_DEPTH, lmr_uncertainty_min_depth_parameter, u32, 4, 3, 5, 0.5),
    (LMR_UNCERTAINTY_MAX_DEPTH, lmr_uncertainty_max_depth_parameter, u32, 10, 8, 12, 0.5),
    (LMR_UNCERTAINTY_MIN_MOVE, lmr_uncertainty_min_move_parameter, u32, 4, 3, 6, 0.5),
    ...
    (FUTILITY_UNCERTAINTY_REFERENCE, futility_uncertainty_reference_parameter, i32, 400, 360, 440, 8.0),
    (FUTILITY_UNCERTAINTY_WEIGHT, futility_uncertainty_weight_parameter, i32, 24, 16, 32, 2.0),
    (FUTILITY_UNCERTAINTY_CONFIDENT_WEIGHT, futility_uncertainty_confident_weight_parameter, i32, 32, 24, 40, 2.0),
    (FUTILITY_UNCERTAINTY_DEADBAND, futility_uncertainty_deadband_parameter, i32, 16, 12, 20, 1.0),
    (FUTILITY_UNCERTAINTY_MIN_DEPTH, futility_uncertainty_min_depth_parameter, u32, 2, 1, 3, 0.5),
    (FUTILITY_UNCERTAINTY_MAX_DEPTH, futility_uncertainty_max_depth_parameter, u32, 5, 4, 6, 0.5),
