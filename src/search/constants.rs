...
define_tunable_parameters!(
    (MAX_CORRECTION_HISTORY_SCORE, max_correction_history_score_parameter, i32, 536, 32, 1024, 32.0),
    (CORRECTION_HISTORY_MINOR_WEIGHT, correction_history_minor_weight_parameter, i32, 209, 0, 512, 16.0),
    (CORRECTION_HISTORY_NON_PAWN_WEIGHT, correction_history_non_pawn_weight_parameter, i32, 344, 0, 512, 16.0),
    (CORRECTION_HISTORY_PREVIOUS_WEIGHT, correction_history_previous_weight_parameter, i32, 156, 0, 512, 16.0),
    (CORRECTION_HISTORY_SAME_SIDE_WEIGHT, correction_history_same_side_weight_parameter, i32, 47, 0, 512, 16.0),
    (CORRECTION_HISTORY_PAWN_UPDATE_SCALE, correction_history_pawn_update_scale_parameter, i32, 159, 0, 384, 16.0),
    (CORRECTION_HISTORY_MINOR_UPDATE_SCALE, correction_history_minor_update_scale_parameter, i32, 150, 0, 384, 16.0),
    (CORRECTION_HISTORY_NON_PAWN_UPDATE_SCALE, correction_history_non_pawn_update_scale_parameter, i32, 215, 0, 384, 16.0),
    (CORRECTION_HISTORY_PREVIOUS_UPDATE_SCALE, correction_history_previous_update_scale_parameter, i32, 145, 0, 384, 16.0),
    ...
    (ASPIRATION_INITIAL_WINDOW, aspiration_initial_window_parameter, i32, 19, 8, 256, 8.0),
    ...
    (Q_DELTA_PRUNING_MARGIN, q_delta_pruning_margin_parameter, i32, 436, 0, 600, 25.0),
    ...
    (DRAW_PREFERENCE_MAX_SCORE, draw_preference_max_score_parameter, i32, 44, 0, 200, 10.0),
    (ROOT_REPETITION_DEFER_MIN_SCORE, root_repetition_defer_min_score_parameter, i32, 125, 0, 600, 25.0),
