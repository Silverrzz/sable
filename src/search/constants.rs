...
define_tunable_parameters!(
    ...
    (CORRECTION_HISTORY_SAME_SIDE_WEIGHT, correction_history_same_side_weight_parameter, i32, 53, 0, 512, 16.0),
    (CORRECTION_HISTORY_PAWN_UPDATE_SCALE, correction_history_pawn_update_scale_parameter, i32, 75, 0, 384, 16.0),
    ...
    (CORRECTION_HISTORY_PREVIOUS_UPDATE_SCALE, correction_history_previous_update_scale_parameter, i32, 159, 0, 384, 16.0),
    (CORRECTION_HISTORY_SAME_SIDE_UPDATE_SCALE, correction_history_same_side_update_scale_parameter, i32, 89, 0, 384, 16.0),
    (CONTINUATION_HISTORY_ORDERING_DIVISOR, continuation_history_ordering_divisor_parameter, i32, 1, 1, 16, 0.5),
    (CAPTURE_HISTORY_ORDERING_DIVISOR, capture_history_ordering_divisor_parameter, i32, 3, 1, 16, 0.5),
    (ASPIRATION_MIN_DEPTH, aspiration_min_depth_parameter, u32, 2, 1, 12, 0.5),
    (ASPIRATION_INITIAL_WINDOW, aspiration_initial_window_parameter, i32, 13, 8, 256, 8.0),
    ...
    (SINGULAR_EXTENSION_MIN_DEPTH, singular_extension_min_depth_parameter, u32, 7, 2, 16, 1.0),
    (SINGULAR_EXTENSION_TT_DEPTH_MARGIN, singular_extension_tt_depth_margin_parameter, u32, 3, 1, 8, 0.5),
    (SINGULAR_EXTENSION_BASE_MARGIN, singular_extension_base_margin_parameter, i32, 24, 0, 128, 8.0),
    (DOUBLE_SINGULAR_EXTENSION_BASE_MARGIN, double_singular_extension_base_margin_parameter, i32, 9, 0, 256, 16.0),
    ...
    (PROBCUT_MARGIN, probcut_margin_parameter, i32, 217, 0, 500, 20.0),
    (PROBCUT_SEE_THRESHOLD, probcut_see_threshold_parameter, i32, 91, -300, 500, 20.0),
    ...
    (NULL_MOVE_EVAL_MARGIN_PER_REDUCTION, null_move_eval_margin_per_reduction_parameter, i32, 191, 1, 600, 25.0),
    ...
    (SEE_PRUNING_BASE_MARGIN, see_pruning_base_margin_parameter, i32, 37, 0, 300, 15.0),
    (SEE_PRUNING_MARGIN_PER_DEPTH, see_pruning_margin_per_depth_parameter, i32, 35, 0, 150, 10.0),
    (Q_DELTA_PRUNING_MARGIN, q_delta_pruning_margin_parameter, i32, 299, 0, 600, 25.0),
    ...
    (DRAW_PREFERENCE_MAX_SCORE, draw_preference_max_score_parameter, i32, 29, 0, 200, 10.0),
    (ROOT_REPETITION_DEFER_MIN_SCORE, root_repetition_defer_min_score_parameter, i32, 212, 0, 600, 25.0),
    (DEFAULT_TIME_ALLOCATION_DIVISOR, default_time_allocation_divisor_parameter, u64, 13, 8, 32, 1.0),
    (INCREMENT_TIME_PERMILLE, increment_time_permille_parameter, u64, 889, 500, 1100, 25.0),
    (HARD_TIME_SOFT_MULTIPLIER_PERMILLE, hard_time_soft_multiplier_permille_parameter, u64, 4242, 2000, 8000, 250.0),
    (HARD_TIME_CLOCK_PERMILLE, hard_time_clock_permille_parameter, u64, 782, 600, 950, 25.0),
    ...
    (TIME_MANAGER_FAIL_LOW_MEDIUM_DROP_CP, time_manager_fail_low_medium_drop_cp_parameter, i32, 131, 100, 180, 5.0),
    (TIME_MANAGER_FAIL_LOW_BIG_DROP_CP, time_manager_fail_low_big_drop_cp_parameter, i32, 234, 200, 400, 10.0),
    (TIME_MANAGER_FAIL_LOW_SMALL_MULTIPLIER, time_manager_fail_low_small_multiplier_parameter, u64, 1250, 1050, 1400, 25.0),
    (TIME_MANAGER_FAIL_LOW_MEDIUM_MULTIPLIER, time_manager_fail_low_medium_multiplier_parameter, u64, 1459, 1400, 1800, 25.0),
    (TIME_MANAGER_FAIL_LOW_BIG_MULTIPLIER, time_manager_fail_low_big_multiplier_parameter, u64, 1964, 1800, 3000, 50.0),
    (TIME_MANAGER_MIN_SOFT_MULTIPLIER, time_manager_min_soft_multiplier_parameter, u64, 857, 700, 950, 10.0),
    (TIME_MANAGER_MAX_SOFT_MULTIPLIER, time_manager_max_soft_multiplier_parameter, u64, 4097, 3000, 6000, 100.0),
    (TIME_MANAGER_MOVE_UNSTABLE_MULTIPLIER, time_manager_move_unstable_multiplier_parameter, u64, 1354, 1100, 1600, 25.0),
    (TIME_MANAGER_MOVE_STABILITY_1_MULTIPLIER, time_manager_move_stability_1_multiplier_parameter, u64, 1123, 1050, 1300, 10.0),
    (TIME_MANAGER_MOVE_STABILITY_2_MULTIPLIER, time_manager_move_stability_2_multiplier_parameter, u64, 1061, 1000, 1150, 10.0),
    (TIME_MANAGER_MOVE_STABILITY_3_MULTIPLIER, time_manager_move_stability_3_multiplier_parameter, u64, 1006, 950, 1050, 5.0),
    (TIME_MANAGER_MOVE_STABLE_MULTIPLIER, time_manager_move_stable_multiplier_parameter, u64, 946, 800, 1000, 10.0),
    (TIME_MANAGER_SCORE_BIG_DELTA_MULTIPLIER, time_manager_score_big_delta_multiplier_parameter, u64, 1378, 1150, 1600, 25.0),
