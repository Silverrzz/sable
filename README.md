...
- Sable uses a principal variation search plus quiescence search with iterative deepening
    ...
    - correction history
        ...
        - non-pawn
        - continuation
- An efficiently updatable neural network - Shard 3.2
    - (768x16hm->768)x2->8 arch
    - Trained on ~1.9 billion positions of selfplay data, 100% of which was DFRC games.
...
## Strength
|Version|My Estimate|CCRL 40/15|CCRL FRC 40/2|CCRL Blitz|
|-|-|-|-|-|
|3.0.0|3450|-|3551|-|
|2.0.0|3300|3258|3314|-|
|1.1.0|2900|2915|-|2932
|1.0.0|2800|-|-|-|
